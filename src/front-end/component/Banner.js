import img1 from '../img/baner-1.png';
                        ...
                        <div className="col-lg-6">
                            <div className="position-relative">
                                <img src={image1} className="img-fluid w-100 rounded" alt=""/>
                                    <div className="d-flex align-items-center justify-content-center bg-white rounded-circle position-absolute" style={{ width: '140px', height: '140px', position: 'absolute', top: '0', left: '0' }}>
